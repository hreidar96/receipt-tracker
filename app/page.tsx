...
import { ArrowRight, Check, Shield, Upload } from "lucide-react";
...
function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="py-20 md:py28 bg-gradient-to-b from-blue-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
            ...
            <div className="space-x-4">
              <Link href="/receipts">
                <Button className="bg-blue-600 hover:bg-blue-700">
                  Get Started <ArrowRight className="m1-2 h-4 w-4" />
                </Button>
              </Link>
              <Link href="#features">
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                Our AI-powered paltform transforms how you handle receipts and
                track expenses.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            ...
            <div className="flex flex-col items-center space-y-2 border -border-gray-200 rounded-lg p-6 dark:border-gray-800">
              <div className="p-3 rounded-full bg-blue-100 dark:bg-blue-900">
                <Upload className="h-6 w-6 text-blue-600 dark:bg-blue-400" />
              </div>
